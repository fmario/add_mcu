...
#ifndef __XL_FPGA_LENS_CORRECT_PLBW_H__
#define __XL_FPGA_LENS_CORRECT_PLBW_H__
...
typedef struct {
    ...
    Xuint16  DeviceId;
    uint32_t  BaseAddr;
} FPGA_LENS_CORRECT_PLBW_Config;

extern FPGA_LENS_CORRECT_PLBW_Config FPGA_LENS_CORRECT_PLBW_ConfigTable[];

// forward declaration of low-level functions
xc_status_t xc_fpga_lens_correct_plbw_create(xc_iface_t **iface, void *config_table);
xc_status_t xc_fpga_lens_correct_plbw_release(xc_iface_t **iface) ;
xc_status_t xc_fpga_lens_correct_plbw_open(xc_iface_t *iface);
xc_status_t xc_fpga_lens_correct_plbw_close(xc_iface_t *iface);
xc_status_t xc_fpga_lens_correct_plbw_read(xc_iface_t *iface, xc_r_addr_t addr, uint32_t *value);
xc_status_t xc_fpga_lens_correct_plbw_write(xc_iface_t *iface, xc_w_addr_t addr, const uint32_t value);
